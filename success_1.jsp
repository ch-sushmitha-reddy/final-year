    ...
    <%
                          String score=request.getParameter("score");
                            String score1=request.getParameter("score1");
                             ...
                             float a,b,c,d=0;
a=Float.parseFloat(score);
b=Float.parseFloat(score1);
c=Float.parseFloat(score2);
d=(a+b+c)/3;
                        %>
    <div id="templatemo_main">
    	<div id="mainCol" class="clearfix">
                  <center>
                      <Font size="4">Your Card Number is: <%=cn%>
                          <br> <br>
                  <Font size="4">1st Finger Print Score: <%=score%>
                          <br> <br>
                               <Font size="4">2nd Finger Print Score: <%=score1%>
                          <br> <br>
                               <Font size="4">3rd Finger Print Score: <%=score2%>
                          <br> <br>
                                <Font size="4">Average: <%=d%>
                          <br> <br>
                   Failed to Login </font> </center>
        </div>
