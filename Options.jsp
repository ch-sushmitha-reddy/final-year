...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
    	<h1>STCARD</h1>
    	<p><span></span> A bank is a financial institution and a financial intermediary that accepts deposits and channels those deposits into lending activities, either directly or through capital markets.</p>
        <p>A bank connects customers that have capital deficits to customers with capital surpluses.</p>
