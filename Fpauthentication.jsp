...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <font color="white" size="5" style="margin-left: 200px"><h>Fingerprint Authentication-1</h></font>
                 <br>
     <%if(Servlet_Msg!=null){
                                    %>
            	...
            	<div id="mainCol" class="clearfix">
                    ...
                    <form name="form1" id="form1" method="post" action="FpCheck" enctype="multipart/form-data" onsubmit="return formValidation();">
