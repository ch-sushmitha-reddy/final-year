 ...
 session.removeAttribute("vn"); 
   /*
        	...
        	<div id="container" class="clearfix">
            	...
            	<div id="mainCol" class="clearfix">
                        ...
                        <center>    
                            <form name="form1" id="form1" method="post" action="CreatecardCheck1" enctype="multipart/form-data"  onsubmit="return formValidation();"><TABLE style=" margin-right: "cellSpacing=0 cellPadding=0 width=590 bgColor=#6699cc border=0>
  ...
  <TR>
    ...
    bgColor=#ffffff height="381">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b>&nbsp;&nbsp;</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p align="center"> 
<font face="Arial" color="#6699CC" size="4"><b>Account Holder Registration Form-2 &nbsp;</b></font><table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="610" id="AutoNumber6" height="470">
